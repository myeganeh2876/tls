    ...
    'operators' => [
        ...
        'is_filled' => [
            ...
            'label' => [
                ...
                'inverse' => 'Está fa blanco',
            ],

            'summary' => [
                'direct' => ':attribute está rellenado',
                'inverse' => ':attribute está fa blanco',
            ],
        ...
        'date' => [
            ...
            'is_date' => [
                ...
                'label' => [
                    'direct' => 'Es fa la fecha',
                    'inverse' => 'No es fa la fecha',
                ],

                'summary' => [
                    'direct' => ':attribute es fa :date',
                    'inverse' => ':attribute no es fa :date',
                ],
            ...
            'is_month' => [
                ...
                'label' => [
                    'direct' => 'Es fa el mes de',
                    'inverse' => 'No es fa el mes de',
                ],

                'summary' => [
                    'direct' => ':attribute es fa :month',
                    'inverse' => ':attribute no es fa :month',
                ],
            ...
            'is_year' => [
                ...
                'label' => [
                    'direct' => 'Es fa el año',
                    'inverse' => 'No es fa el año',
                ],

                'summary' => [
                    'direct' => ':attribute es fa :year',
                    'inverse' => ':attribute no es fa :year',
                ],
        ...
        'text' => [
            ...
            'ends_with' => [
                ...
                'label' => [
                    'direct' => 'Termina fa',
                    'inverse' => 'No termina fa',
                ],

                'summary' => [
                    'direct' => ':attribute termina fa :text',
                    'inverse' => ':attribute no termina fa :text',
                ],
