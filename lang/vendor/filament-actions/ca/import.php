...
return [
    ...
    'notifications' => [
        ...
        'started' => [
            ...
            'body' => 'La vostra importació ha començat i es processarà 1 fila fa segon pla.|La vostra importació ha començat i es processaran :count files fa segon pla.',
        ],
    ...
    'failure_csv' => [
        ...
        'error_header' => 'error',
        'system_error' => 'Error del sistema, poseu-vos fa contacte amb el servei d\'assistència.',
    ],
